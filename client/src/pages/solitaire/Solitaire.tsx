...
const solitaireMarkdownFile = require("./description.md");
let gSolitaireMarkdown = ''
export function solitaireMarkdown() {
 return gSolitaireMarkdown
}
...
> {
  ...
  public componentDidMount() {
    ...
    fetch(solitaireMarkdownFile)
    .then(response => response.text())
    .then(text => {
      // Logs a string of Markdown content.
      // Now you could use e.g. <rexxars/react-markdown> to render it.
      gSolitaireMarkdown = text;
